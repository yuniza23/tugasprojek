        ...
        "menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo base_url() ?>/index.php/profil" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Profil</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo base_url() ?>/index.php/Struktur" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Struktur Jabatan</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo base_url() ?>/index.php/Tufoksi" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Tupoksi</p>
                </a>
              </li>
